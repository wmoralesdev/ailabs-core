    ...
    variants: {
      variant: {
        ...
        primary:
          "bg-primary text-primary-foreground hover:bg-primary/85 focus-visible:ring-primary/30",
        outline:
          "border-border bg-transparent text-foreground hover:bg-lavender/60 hover:text-foreground aria-expanded:bg-muted aria-expanded:text-foreground dark:bg-input/30",
        secondary:
          "border border-border bg-secondary text-secondary-foreground hover:border-purple/50 hover:bg-lavender/40 aria-expanded:bg-secondary aria-expanded:text-secondary-foreground",
        ghost:
          "text-foreground hover:bg-lavender hover:text-foreground aria-expanded:bg-lavender aria-expanded:text-foreground dark:hover:bg-muted/50",
        "on-dark":
          "bg-white text-graphite hover:bg-white/90 focus-visible:border-purple-soft focus-visible:ring-purple-soft/40",
        destructive:
